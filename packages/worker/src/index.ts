...
export class Database {
  ...
  constructor(
    ...
    if (Database.isNodejs) {
      console.log("sqleet: Using Node.JS Worker");
      ...
      console.log("sqleet: Using Shared Worker");
      ...
      console.warn("sqleet: Using Web Worker. Experience will be degraded.");
      this.worker = new Worker(workerUrl);
    } else if (
      !Database.isSharedWorkerSupported &&
      (!Database.isWorkerSupported || Database.isIEOrLegacyEdge) &&
      ...
      console.warn("sqleet: Using Pseudo Web Worker. Experience will be degraded heavily.");
