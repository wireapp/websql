...
export const isNodejs = typeof process === 'object' && typeof process.versions === 'object' && typeof process.versions.node === 'string';

export const DatabaseAlreadyMountedError = (message: string) => new ExtendableError(message, 'DatabaseAlreadyMountedError');
